...
<html>
<head>
<title>所有task假資料 - listAllTask.jsp</title>
...
<table>
	...
	<c:forEach var="taskVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			...
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/task/task.do" style="margin-bottom: 0px;">
